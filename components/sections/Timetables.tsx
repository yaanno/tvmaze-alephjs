  ...
  return (
    <div className="">
      ...
      {shows.map((show) => (
        <div
          key={show.url}
          className="grid grid-cols-5 bg-slate-100 odd:bg-white"
        >
          <div className="col-span-1 lg:col-span-1 md:col-span-2 self-center p-4">
          ...
          <div className="col-span-4 lg:col-span-4 md:col-span-3 py-4 px-4 md:px-0 lg:px-4 self-center">
